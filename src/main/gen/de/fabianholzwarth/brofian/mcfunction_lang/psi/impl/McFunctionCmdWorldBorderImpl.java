...
public class McFunctionCmdWorldBorderImpl extends ASTWrapperPsiElement implements McFunctionCmdWorldBorder {

  public McFunctionCmdWorldBorderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdWorldBorder(this);
  }
