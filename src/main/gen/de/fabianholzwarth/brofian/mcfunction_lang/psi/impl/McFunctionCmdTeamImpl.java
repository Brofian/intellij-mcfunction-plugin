...
public class McFunctionCmdTeamImpl extends ASTWrapperPsiElement implements McFunctionCmdTeam {

  public McFunctionCmdTeamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdTeam(this);
  }
  ...
  @Override
  @Nullable
  public McFunctionCmdTeamModOptions getCmdTeamModOptions() {
    return findChildByClass(McFunctionCmdTeamModOptions.class);
  }
