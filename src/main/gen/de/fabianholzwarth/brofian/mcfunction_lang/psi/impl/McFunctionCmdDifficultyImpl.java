...
public class McFunctionCmdDifficultyImpl extends ASTWrapperPsiElement implements McFunctionCmdDifficulty {

  public McFunctionCmdDifficultyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdDifficulty(this);
  }
