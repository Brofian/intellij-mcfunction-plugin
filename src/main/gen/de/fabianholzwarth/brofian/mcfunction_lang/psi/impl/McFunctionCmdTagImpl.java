...
public class McFunctionCmdTagImpl extends ASTWrapperPsiElement implements McFunctionCmdTag {

  public McFunctionCmdTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdTag(this);
  }
