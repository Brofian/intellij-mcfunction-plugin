...
public class McFunctionCmdExecuteConditionImpl extends ASTWrapperPsiElement implements McFunctionCmdExecuteCondition {

  public McFunctionCmdExecuteConditionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdExecuteCondition(this);
  }
  ...
  @Override
  @Nullable
  public McFunctionDataType getDataType() {
    return findChildByClass(McFunctionDataType.class);
  }
