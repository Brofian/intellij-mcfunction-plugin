...
public class McFunctionCmdDefaultGameModeImpl extends ASTWrapperPsiElement implements McFunctionCmdDefaultGameMode {

  public McFunctionCmdDefaultGameModeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdDefaultGameMode(this);
  }
