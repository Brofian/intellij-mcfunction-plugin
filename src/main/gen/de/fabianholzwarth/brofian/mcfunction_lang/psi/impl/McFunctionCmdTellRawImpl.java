...
public class McFunctionCmdTellRawImpl extends ASTWrapperPsiElement implements McFunctionCmdTellRaw {

  public McFunctionCmdTellRawImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdTellRaw(this);
  }
