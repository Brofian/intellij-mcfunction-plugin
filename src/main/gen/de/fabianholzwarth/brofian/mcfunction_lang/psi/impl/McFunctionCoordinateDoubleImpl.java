...
public class McFunctionCoordinateDoubleImpl extends ASTWrapperPsiElement implements McFunctionCoordinateDouble {

  public McFunctionCoordinateDoubleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCoordinateDouble(this);
  }
