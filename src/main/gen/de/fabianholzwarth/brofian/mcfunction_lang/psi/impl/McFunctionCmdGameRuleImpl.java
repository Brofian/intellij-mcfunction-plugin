...
public class McFunctionCmdGameRuleImpl extends ASTWrapperPsiElement implements McFunctionCmdGameRule {

  public McFunctionCmdGameRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdGameRule(this);
  }
