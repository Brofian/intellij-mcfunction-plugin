...
public class McFunctionCmdEffectImpl extends ASTWrapperPsiElement implements McFunctionCmdEffect {

  public McFunctionCmdEffectImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdEffect(this);
  }
