...
public class McFunctionCmdLocateImpl extends ASTWrapperPsiElement implements McFunctionCmdLocate {

  public McFunctionCmdLocateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdLocate(this);
  }
