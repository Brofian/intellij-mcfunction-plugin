...
public class McFunctionCmdScoreboardObjectivesImpl extends ASTWrapperPsiElement implements McFunctionCmdScoreboardObjectives {

  public McFunctionCmdScoreboardObjectivesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdScoreboardObjectives(this);
  }
