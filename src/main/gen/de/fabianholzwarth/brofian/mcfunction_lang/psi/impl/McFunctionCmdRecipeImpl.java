...
public class McFunctionCmdRecipeImpl extends ASTWrapperPsiElement implements McFunctionCmdRecipe {

  public McFunctionCmdRecipeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdRecipe(this);
  }
