...
public class McFunctionCmdPlaySoundSourceImpl extends ASTWrapperPsiElement implements McFunctionCmdPlaySoundSource {

  public McFunctionCmdPlaySoundSourceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdPlaySoundSource(this);
  }
