...
public class McFunctionCmdTriggerImpl extends ASTWrapperPsiElement implements McFunctionCmdTrigger {

  public McFunctionCmdTriggerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdTrigger(this);
  }
