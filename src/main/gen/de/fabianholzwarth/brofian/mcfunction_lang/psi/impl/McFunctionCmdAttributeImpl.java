...
public class McFunctionCmdAttributeImpl extends ASTWrapperPsiElement implements McFunctionCmdAttribute {

  public McFunctionCmdAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdAttribute(this);
  }
