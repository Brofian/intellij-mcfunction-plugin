...
public class McFunctionLine_Impl extends ASTWrapperPsiElement implements McFunctionLine_ {

  public McFunctionLine_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitLine_(this);
  }
