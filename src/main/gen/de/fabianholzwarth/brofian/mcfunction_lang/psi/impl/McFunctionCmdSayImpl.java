...
public class McFunctionCmdSayImpl extends ASTWrapperPsiElement implements McFunctionCmdSay {

  public McFunctionCmdSayImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSay(this);
  }
