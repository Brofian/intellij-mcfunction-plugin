...
public class McFunctionFreeMessageValuesImpl extends ASTWrapperPsiElement implements McFunctionFreeMessageValues {

  public McFunctionFreeMessageValuesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitFreeMessageValues(this);
  }
