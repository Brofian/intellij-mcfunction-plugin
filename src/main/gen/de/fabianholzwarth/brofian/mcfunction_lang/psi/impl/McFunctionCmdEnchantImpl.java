...
public class McFunctionCmdEnchantImpl extends ASTWrapperPsiElement implements McFunctionCmdEnchant {

  public McFunctionCmdEnchantImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdEnchant(this);
  }
