...
public class McFunctionCmdPardonImpl extends ASTWrapperPsiElement implements McFunctionCmdPardon {

  public McFunctionCmdPardonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdPardon(this);
  }
