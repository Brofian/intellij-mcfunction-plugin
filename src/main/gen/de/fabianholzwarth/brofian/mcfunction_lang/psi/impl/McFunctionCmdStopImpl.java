...
public class McFunctionCmdStopImpl extends ASTWrapperPsiElement implements McFunctionCmdStop {

  public McFunctionCmdStopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdStop(this);
  }
