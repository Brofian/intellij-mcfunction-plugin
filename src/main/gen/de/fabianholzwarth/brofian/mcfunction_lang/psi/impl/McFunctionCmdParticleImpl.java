...
public class McFunctionCmdParticleImpl extends ASTWrapperPsiElement implements McFunctionCmdParticle {

  public McFunctionCmdParticleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdParticle(this);
  }
