...
public class McFunctionTargetSelectorImpl extends ASTWrapperPsiElement implements McFunctionTargetSelector {

  public McFunctionTargetSelectorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitTargetSelector(this);
  }
