...
public class McFunctionCmdSpawnPointImpl extends ASTWrapperPsiElement implements McFunctionCmdSpawnPoint {

  public McFunctionCmdSpawnPointImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSpawnPoint(this);
  }
