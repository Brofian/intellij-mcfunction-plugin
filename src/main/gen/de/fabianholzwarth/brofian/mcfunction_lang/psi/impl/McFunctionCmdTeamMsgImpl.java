...
public class McFunctionCmdTeamMsgImpl extends ASTWrapperPsiElement implements McFunctionCmdTeamMsg {

  public McFunctionCmdTeamMsgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdTeamMsg(this);
  }
