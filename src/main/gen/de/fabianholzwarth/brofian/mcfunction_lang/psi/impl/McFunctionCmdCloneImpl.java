...
public class McFunctionCmdCloneImpl extends ASTWrapperPsiElement implements McFunctionCmdClone {

  public McFunctionCmdCloneImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdClone(this);
  }
