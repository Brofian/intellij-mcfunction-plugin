...
public class McFunctionCmdReloadImpl extends ASTWrapperPsiElement implements McFunctionCmdReload {

  public McFunctionCmdReloadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdReload(this);
  }
