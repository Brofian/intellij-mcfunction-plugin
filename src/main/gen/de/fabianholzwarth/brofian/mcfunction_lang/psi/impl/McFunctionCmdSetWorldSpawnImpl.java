...
public class McFunctionCmdSetWorldSpawnImpl extends ASTWrapperPsiElement implements McFunctionCmdSetWorldSpawn {

  public McFunctionCmdSetWorldSpawnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSetWorldSpawn(this);
  }
