...
public class McFunctionCmdPlaceImpl extends ASTWrapperPsiElement implements McFunctionCmdPlace {

  public McFunctionCmdPlaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdPlace(this);
  }
