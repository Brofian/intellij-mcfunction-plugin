...
public class McFunctionCmdTitleImpl extends ASTWrapperPsiElement implements McFunctionCmdTitle {

  public McFunctionCmdTitleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdTitle(this);
  }
  ...
  @Override
  @NotNull
  public List<McFunctionTimeValue> getTimeValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, McFunctionTimeValue.class);
  }
