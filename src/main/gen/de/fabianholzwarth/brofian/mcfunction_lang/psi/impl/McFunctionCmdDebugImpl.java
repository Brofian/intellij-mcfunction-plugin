...
public class McFunctionCmdDebugImpl extends ASTWrapperPsiElement implements McFunctionCmdDebug {

  public McFunctionCmdDebugImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdDebug(this);
  }
