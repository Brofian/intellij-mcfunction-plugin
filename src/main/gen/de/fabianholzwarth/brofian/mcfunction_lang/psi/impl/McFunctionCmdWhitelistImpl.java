...
public class McFunctionCmdWhitelistImpl extends ASTWrapperPsiElement implements McFunctionCmdWhitelist {

  public McFunctionCmdWhitelistImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdWhitelist(this);
  }
