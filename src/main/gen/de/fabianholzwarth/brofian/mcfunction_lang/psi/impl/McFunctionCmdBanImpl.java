...
public class McFunctionCmdBanImpl extends ASTWrapperPsiElement implements McFunctionCmdBan {

  public McFunctionCmdBanImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdBan(this);
  }
