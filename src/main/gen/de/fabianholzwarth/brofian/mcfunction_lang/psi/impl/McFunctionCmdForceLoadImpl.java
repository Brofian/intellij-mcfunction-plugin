...
public class McFunctionCmdForceLoadImpl extends ASTWrapperPsiElement implements McFunctionCmdForceLoad {

  public McFunctionCmdForceLoadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdForceLoad(this);
  }
