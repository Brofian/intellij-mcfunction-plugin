...
public class McFunctionCmdDamageImpl extends ASTWrapperPsiElement implements McFunctionCmdDamage {

  public McFunctionCmdDamageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdDamage(this);
  }
