...
public class McFunctionCoordinateTripleImpl extends ASTWrapperPsiElement implements McFunctionCoordinateTriple {

  public McFunctionCoordinateTripleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCoordinateTriple(this);
  }
