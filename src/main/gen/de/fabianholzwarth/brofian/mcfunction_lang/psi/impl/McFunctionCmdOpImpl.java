...
public class McFunctionCmdOpImpl extends ASTWrapperPsiElement implements McFunctionCmdOp {

  public McFunctionCmdOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdOp(this);
  }
