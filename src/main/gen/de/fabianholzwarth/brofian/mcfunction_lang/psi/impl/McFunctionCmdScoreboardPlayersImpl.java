...
public class McFunctionCmdScoreboardPlayersImpl extends ASTWrapperPsiElement implements McFunctionCmdScoreboardPlayers {

  public McFunctionCmdScoreboardPlayersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdScoreboardPlayers(this);
  }
