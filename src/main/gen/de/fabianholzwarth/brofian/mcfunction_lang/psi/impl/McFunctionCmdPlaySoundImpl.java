...
public class McFunctionCmdPlaySoundImpl extends ASTWrapperPsiElement implements McFunctionCmdPlaySound {

  public McFunctionCmdPlaySoundImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdPlaySound(this);
  }
