...
public class McFunctionCmdSummonImpl extends ASTWrapperPsiElement implements McFunctionCmdSummon {

  public McFunctionCmdSummonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSummon(this);
  }
