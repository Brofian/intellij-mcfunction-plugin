...
public class McFunctionExtendedIdentifierImpl extends ASTWrapperPsiElement implements McFunctionExtendedIdentifier {

  public McFunctionExtendedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
