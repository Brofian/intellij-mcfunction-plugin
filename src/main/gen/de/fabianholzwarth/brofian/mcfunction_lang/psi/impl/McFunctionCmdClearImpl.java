...
public class McFunctionCmdClearImpl extends ASTWrapperPsiElement implements McFunctionCmdClear {

  public McFunctionCmdClearImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdClear(this);
  }
