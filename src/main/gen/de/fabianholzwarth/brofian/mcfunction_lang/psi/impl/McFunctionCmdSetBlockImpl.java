...
public class McFunctionCmdSetBlockImpl extends ASTWrapperPsiElement implements McFunctionCmdSetBlock {

  public McFunctionCmdSetBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSetBlock(this);
  }
