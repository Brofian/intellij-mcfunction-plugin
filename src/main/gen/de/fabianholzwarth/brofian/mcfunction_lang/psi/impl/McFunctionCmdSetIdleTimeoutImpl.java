...
public class McFunctionCmdSetIdleTimeoutImpl extends ASTWrapperPsiElement implements McFunctionCmdSetIdleTimeout {

  public McFunctionCmdSetIdleTimeoutImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSetIdleTimeout(this);
  }
