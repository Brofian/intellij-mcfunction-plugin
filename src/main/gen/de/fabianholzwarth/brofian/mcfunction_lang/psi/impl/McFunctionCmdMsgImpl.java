...
public class McFunctionCmdMsgImpl extends ASTWrapperPsiElement implements McFunctionCmdMsg {

  public McFunctionCmdMsgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdMsg(this);
  }
