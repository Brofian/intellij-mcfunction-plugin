...
public class McFunctionCmdDataPackImpl extends ASTWrapperPsiElement implements McFunctionCmdDataPack {

  public McFunctionCmdDataPackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdDataPack(this);
  }
