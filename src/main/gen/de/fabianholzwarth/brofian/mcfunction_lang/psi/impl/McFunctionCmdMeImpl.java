...
public class McFunctionCmdMeImpl extends ASTWrapperPsiElement implements McFunctionCmdMe {

  public McFunctionCmdMeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdMe(this);
  }
