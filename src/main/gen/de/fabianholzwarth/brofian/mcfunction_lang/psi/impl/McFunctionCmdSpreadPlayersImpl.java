...
public class McFunctionCmdSpreadPlayersImpl extends ASTWrapperPsiElement implements McFunctionCmdSpreadPlayers {

  public McFunctionCmdSpreadPlayersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSpreadPlayers(this);
  }
