...
public class McFunctionCmdSpectateImpl extends ASTWrapperPsiElement implements McFunctionCmdSpectate {

  public McFunctionCmdSpectateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitCmdSpectate(this);
  }
