...
public class McFunctionAnnotator implements Annotator {
    ...
    public void annotate(@NotNull final PsiElement element, @NotNull AnnotationHolder holder) {
        ...
        holder.newSilentAnnotation(HighlightSeverity.INFORMATION)
                .range(separatorRange).textAttributes(McFunctionSyntaxHighlighter.SEPARATOR).create();
        ...
        if (properties.isEmpty()) {
            ...
            holder.newSilentAnnotation(HighlightSeverity.INFORMATION)
                    .range(keyRange).textAttributes(McFunctionSyntaxHighlighter.VALUE).create();
        }
    }
